...
5. DOCUMENT: cycles/ads_cycle_YYYYMMDD_HHMM.md (cost-per-seller scorecard, WHY, TIER-3 proposals + kill/scale rules, next-cycle plan). Append to 01_BUILD_LOG.md. Send Will ONE concise Telegram: blended cost-per-seller + the top 1-2 proposed moves.
