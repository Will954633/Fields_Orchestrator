...
5. DOCUMENT: cycles/articles_cycle_YYYYMMDD_HHMM.md (what converts + WHY, the topic backlog + hypotheses, what needs Will). Append to 01_BUILD_LOG.md. Telegram Will ONE concise summary: top converting topic + the next 1-2 proposed pieces.
