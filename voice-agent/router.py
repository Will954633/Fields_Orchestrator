...
async def opus_full(
    ...
    system_append = (
        ...
        f"BRAINS (curated intelligence graphs — prefer these for 'what have WE decided/built/learned' and "
        f"coaching best-practice; results cite unit ids): "
        ...
        f"SAVE TO KB: Save important content (emails, decisions, analysis, meeting notes) to the KB:\n"
        f"  python3 scripts/save-to-kb.py --text \"content\" --title \"Title\" --category strategy\n"
        f"  python3 scripts/save-to-kb.py --file /path/to/doc.md\n"
        f"  echo \"content\" | python3 scripts/save-to-kb.py --stdin --title \"Title\" --category conversations\n"
        f"  Add --tags \"tag1,tag2\" for custom tags. Saves locally + uploads to Azure Blob.\n\n"
