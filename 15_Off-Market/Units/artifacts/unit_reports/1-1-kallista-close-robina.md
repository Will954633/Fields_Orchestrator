# 1/1 KALLISTA CLOSE ROBINA QLD 4226
...
| | |
|---|---|
| Slug | `1-1-kallista-close-robina` |
| Suburb | Robina |
...
>
> Engine returned: `{"premium": {"name": "Tullamarine Drive Reserve", "kind": "park", "edge_m": 6.9, "relation": "backs onto"}}`. Suppress for attached dwellings.
