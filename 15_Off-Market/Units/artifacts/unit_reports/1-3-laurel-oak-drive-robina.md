# 1/3 LAUREL OAK DRIVE ROBINA QLD 4226
...
| | |
|---|---|
| Slug | `1-3-laurel-oak-drive-robina` |
| Suburb | Robina |
...
A family who has outgrown their current home but wants the space and backyard to stay in Robina for the long haul.

Right now it's your home. To them, it's the one they've been waiting for.

What a cheaper home can't give them: Mountain Ash Reserve a short walk away.
...
> **GAP [G2]** — scarcity cohort is untyped - this counts the DETACHED HOUSE market.
>
> Rendered above: 100 of 183. That denominator is the **detached-house** active pool (`scarcity_features.count_active_matches` has no property_type filter). On the live site this is what produces "107 of 233 nearby homes".

> **GAP [G3]** — green_space makes a boundary claim from a single geocode; invalid for a scheme.
>
> Engine returned: `{"premium": {"name": "Lancewood Circuit Reserve", "kind": "park", "edge_m": 139.4, "relation": "steps from"}}`. Suppress for attached dwellings.

> **GAP [G5]** — buyer archetype is a detached-house persona.
...
Engine-reported gaps: `no comparable sale`

**GAP markers in this report: 11** — C2, D1, D3, D4, E1, E2, F5, G2, G3, G4, G5
