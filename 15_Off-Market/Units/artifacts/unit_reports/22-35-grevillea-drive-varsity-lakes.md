# 22/35 GREVILLEA DRIVE VARSITY LAKES QLD 4227
...
This home is one of **49 homes** in **Greenlands** — a villa and townhouse complex, community titles scheme CMS21006.

The buildings in it stand **low-rise (1–2 storeys)** (about 8 m). Derived from Queensland LiDAR building outlines captured in 2022 — accurate to within one storey nine times in ten, which is why it is stated as a band rather than a number.

The typical lot in this scheme is 312 m².
...
### Where it sits in Greenlands

There are **49** lots in this scheme. That is the number a buyer is really choosing between — the closest substitute for this home is another home in this building, not a house down the road.

### At the doorstep

- Varsity College Primary Campus — 1245m
- Goodstart Early Learning Burleigh — 1035m
- Coles Burleigh Waters — 756m
- Frascott Park — 207m
- Home Plate Kitchen — 314m
- Nobby Beach — 3003m
...
| | |
|---|---|
| Slug | `22-35-grevillea-drive-varsity-lakes` |
| Dwelling class | attached |
| Scheme | Greenlands · GTP1783 · CMS21006 |
| Scheme size | 49 dwellings (cadastre parcels: 6) |
| Subtype | group_title |
| Valuation | declined |
| Floor area | — |
