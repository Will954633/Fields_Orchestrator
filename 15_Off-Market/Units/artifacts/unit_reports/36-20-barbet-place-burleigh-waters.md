# 36/20 BARBET PLACE BURLEIGH WATERS QLD 4220
...
_no attributes recorded_

This home is one of **81 homes** in **Burleigh Shores** — an apartment building with shared common property, community titles scheme CMS10871.
...
The typical lot in this scheme is 14920 m², and the scheme holds 29,840 m² of common property.
...
### We are not going to put a figure on this home

No sale in this scheme, and too few same-type sales of this size in the suburb, to support a range.

*Decline reason: `no_class_matched_comparables`. Tiers attempted: same_complex_any_beds=0.*

> This is the correct output, not a hole — a range built from homes that are not genuinely comparable would be worse than no range. The page should say so and explain what would change it.
...
### Where it sits in Burleigh Shores

There are **81** lots in this scheme. That is the number a buyer is really choosing between — the closest substitute for this home is another home in this building, not a house down the road.

### At the doorstep

- Caningeraba State School. — 859m
- Sports Centre of Excellence — 1709m
- Little Scholars Burleigh Waters — 518m
- Coles Miami — 1132m
- John Handley Community Complex — 245m
- Barrio Cafe Neighborhood Espresso — 253m
...
One thing we could not verify: bedrooms.
...
| | |
|---|---|
| Slug | `36-20-barbet-place-burleigh-waters` |
| Dwelling class | attached |
| Scheme | Burleigh Shores · BUP4314 · CMS10871 |
| Scheme size | 81 dwellings (cadastre parcels: 10) |
