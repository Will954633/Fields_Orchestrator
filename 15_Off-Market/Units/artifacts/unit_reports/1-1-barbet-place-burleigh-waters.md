# 1/1 BARBET PLACE BURLEIGH WATERS QLD 4220
...
| | |
|---|---|
| Slug | `1-1-barbet-place-burleigh-waters` |
...
>
> Engine emitted **$816,300 – $997,700** for this dwelling via `method=thin`, n_comps=20. ⚠ **This is not a refusal — it is a number.** The V4 React page suppresses it (it requires `valuation_data.confidence.range.low`), but the DISCOVERY DECK renders this card, and the deck is the default in every non-V4 suburb. Verify before shipping the unit arm.
...
>
> Engine returned: `{"premium": {"name": "Miami Lake", "kind": "water", "edge_m": 29.4, "relation": "adjoins"}}`. Suppress for attached dwellings.
