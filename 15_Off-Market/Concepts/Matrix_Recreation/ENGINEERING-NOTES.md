# Engineering notes — Matrix digital rain

Detailed build notes for all four versions, kept in the order they were built.
**Start at [README.md](README.md)** — it says which version is preferred and
where everything lives. This file is the depth behind it: design reasoning,
measured numbers, and the bugs found along the way.
