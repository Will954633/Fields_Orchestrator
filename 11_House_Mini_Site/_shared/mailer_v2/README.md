...
of the mini-site mailer. This is the stock for every mailer print run (V1 and V2)
unless he says otherwise. Silk holds the aerial/hero photography without the glare of
gloss, and 210 GSM is heavy enough that an A4 duplex leaflet doesn't show through or
feel like a flyer. Same decision recorded in `../mailer/README.md`.
