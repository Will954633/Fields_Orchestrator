...
def facts_block(context: dict) -> tuple[str, list[str]]:
    ...
    return (
        ...
        "- Several suburbs are listed and their figures are NOT interchangeable. "
        "Find the heading for the suburb you are being asked about and take every "
        "number from under that heading only. Check the heading before you state a "
        "figure, not after — a visible mid-sentence correction reads worse than a "
        "pause. If you do notice an error while writing, rewrite the sentence "
        "cleanly rather than correcting yourself inline.\n"
